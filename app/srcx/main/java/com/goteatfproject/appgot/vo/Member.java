...
public class Member {
  ...
  public String toString() {
    return "Member [no=" + no + ", id=" + id + ", password=" + password + ", password2=" + password2
        + ", grade=" + grade + ", name=" + name + ", birth=" + birth + ", tel=" + tel + ", gender="
        + gender + ", createdDate=" + createdDate + ", post=" + post + ", address=" + address
        + ", subAddr=" + subAddr + ", interest=" + interest + ", outState=" + outState
        + ", outDate=" + outDate + ", profile=" + profile + ", intro=" + intro + "]";
  }
  public int getNo() {
    return no;
  }
